...
addCommandAlias("hot-sc", "compilation/jmh:run HotScalacBenchmark")

addCommandAlias("cold-sc", "compilation/jmh:run ColdScalacBenchmark")

addCommandAlias("hot-dc", "compilation/jmh:run HotDotcBenchmark")

addCommandAlias("cold-dc", "compilation/jmh:run ColdDotcBenchmark")
